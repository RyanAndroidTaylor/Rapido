 ...
 */
class NetworkErrorHandler(val context: Context, val onErrorHandled: () -> Unit, val customErrorHandler: CustomErrorHandler? = null) {
    ...
    interface CustomErrorHandler {
        fun handleError(error: Error, networkErrorHandler: NetworkErrorHandler)
    }
}